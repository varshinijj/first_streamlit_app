...
scl = sc.loc[sc['DATABASE']==option].reset_index()
scl
...
tabl2 = tabl1.loc[tabl1['DATABASE']==option].reset_index()
tabl2
...
disp = dis.loc[dis['OBJECT_NAME']==final][['COLUMN_NAME','TAG_NAME','TAG_VALUE']]
disp
